<?php
require_once '../../modules/Server/Server.php';
$server = new Server();
...
<table id="php-check">    	
    ...
    <tr>    	
    	<td colspan="2" align="right"><input<?=$disabled_tag?> type="button" value="Next >>"<?php if($enabled) {?> hashtag="dbsetup" onclick="hash_change(this)"<?php }?> progress="2"/></td>
    </tr>
