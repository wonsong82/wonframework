...
<?php } } ?>
    ...
    <form id="new-file-form">
        ...
        <input type="file" id="new-file" name="bannerimage" accept="image/x-png,image/jpeg,image/gif" />        <input type="hidden" name="method" value="add" />
...
$(function(){
	...
	form.attr('action' , module_dir + '/' + module + '/admin/admin_controller.php');
...
function refresh_page() {
	...
	$.ajax({
		url : module_dir + '/' + module + '/admin/admin.php',
		type : 'post',
		async : false,
		cache : false,
		success : function(data) {
